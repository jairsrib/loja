 ...
 * @author Jair
 */
public class FrConTamanhoRoupa extends javax.swing.JDialog {

    /**
     * Creates new form FrConTamanhoRoupa
     */
    public FrConTamanhoRoupa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tblRoupaDisponivel = new javax.swing.JTable();
        ...
        tblRoupaDisponivel.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tblRoupaDisponivel);
        ...
        lblTitulo.setText("Roupas Disponíveis");
    ...
    public void pesquisar() {
        ...
        // o 
        DefaultTableModel modeloTabela = (DefaultTableModel) tblRoupaDisponivel.getModel();
        ...
        List<Roupa_Tamanho> listaTamRoupa = controller.consultarTam();

        //Preencher a grade
        //percorre todos os usuários presentes na lista
        for (Roupa_Tamanho rt : listaTamRoupa) {
            //cria um array onde cada posição é o valor das colunas da grade
            Object[] linha = {
                rt.getId_roupa(), //coluna 0
                rt.getId_tamanho(), //coluna 1
            };
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrConTamanhoRoupa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrConTamanhoRoupa dialog = new FrConTamanhoRoupa(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable tblRoupaDisponivel;
