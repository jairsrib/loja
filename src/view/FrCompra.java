...
public class FrCompra extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        edtQuantidade.setBackground(new java.awt.Color(255, 255, 255));
    ...
    private void btnComprarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnComprarMouseClicked
        if (tblRoupas.getSelectedRow() != -1) {
            ...
            compra.setId_roupa(id_roupa);
            compra.setId_cliente(pkusuario); //pkusuario é o atributo da classe que veio do menu
            compra.setQuantidade(quantidade);
            
            CompraController controller = new CompraController();
            if (controller.inserirCompra(compra)) {
    ...
    public void pesquisar() {
        ...
        // o 
        DefaultTableModel modeloTabela = (DefaultTableModel) tblRoupas.getModel();
