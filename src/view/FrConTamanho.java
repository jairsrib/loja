 ...
 * @author Jair
 */
public class FrConTamanho extends javax.swing.JDialog {

    /**
     * Creates new form FrConTamanho
     */
    public FrConTamanho(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
public void pesquisar(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrConTamanho.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrConTamanho dialog = new FrConTamanho(new javax.swing.JFrame(), true);
